...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ISAKA Sports Global Ventures Ltd" },
      {
        name: "description",
        content:
          "Football coaching, player development and sports management by ISAKA Sports Global Ventures Ltd.",
      },
      { name: "author", content: "ISAKA Sports Global Ventures Ltd" },
